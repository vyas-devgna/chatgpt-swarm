...
Version: **0.1.0 engineering preview**
...
- Manual model selection, persona editing, Add agent, Pause/Resume, explicit `REQUIRES_USER`, and embedded worker projections are not in 0.1.0; Auto model fallback and Open chat are the deliberate preview scope.
...
- Release commit: resolved exactly by the immutable `v0.1.0` tag after publication
- Release tag: `v0.1.0` engineering prerelease
- Installable archive: `.output/chatgpt-swarm-0.1.0-chrome.zip`
- Archive SHA-256: `8adce204f9571ff4f48c22df5865ad8bc37105b2f644d47db966c5033176a845`
